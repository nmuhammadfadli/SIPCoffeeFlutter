...
class QuizPanen extends StatefulWidget {
  final Quiz quiz;

  const QuizPanen({required this.quiz, super.key});

  @override
  State<QuizPanen> createState() => _QuizPanenState();
}

class _QuizPanenState extends State<QuizPanen> {
