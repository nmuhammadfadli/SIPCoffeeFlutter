...
class QuizPerawatan extends StatefulWidget {
  final Quiz quiz;

  const QuizPerawatan({required this.quiz, super.key});

  @override
  State<QuizPerawatan> createState() => _QuizPerawatanState();
}

class _QuizPerawatanState extends State<QuizPerawatan> {
