...
class RoastingAddNew extends StatefulWidget {
  @override
  _RoastingAddNewState createState() => _RoastingAddNewState();
}

class _RoastingAddNewState extends State<RoastingAddNew> {
  ...
  List<String> kodeHasilPanenList = PanenNewPage.daftarHasilPanen.map((data) => data['id_hasil_panen'].toString()).toList();
      ...
      if (response.statusCode == 200) {
        ...
        if (jsonResponse is List && jsonResponse.isNotEmpty && jsonResponse[0] is List) {
          ...
          if (innerList.isNotEmpty && innerList[0] is Map<String, dynamic>) {
            setState(() {
              kodeHasilPanenList = innerList.map((item) => item['kode_lahan'] as String).toList();
            });
          } else {
          ...
          child: Column(
            ...
            children: [
              ...
              DropdownButtonFormField<String>(
                ...
                items: kodeHasilPanenList.map<DropdownMenuItem<String>>((String value) {
